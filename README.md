...
- 24.06.2013
	...
	1. Убрал логотип внутри балуна меток, которые в виде слоя экспортируются на www.izh.ru
	2. Выделил адрес внутри балуна красным цветом, чтобы эта информация была заметнее.
